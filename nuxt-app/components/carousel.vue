    ...
    <div class="carousel-container">
              ...
              <figure>
                ...
                <figcaption>
                  ...
                  <p class="beschrijving">
                    ...
                    and Wylan want to take over the swings, but one person
                    stands in their way.
                  </p>
                </figcaption>
              </figure>
      ...
      <div class="carousel-button">
        <button @click="prevSlide" aria-label="Previous Slide">
          <img src="/left.svg" class="button-carousel" alt="Previous Slide" />
        </button>
        ...
        <button @click="nextSlide" aria-label="Next Slide">
          <img src="/right.svg" class="button-carousel" alt="Next Slide" />
        </button>
      </div>
    </div>
  </div>
...
.links-onder,
.add-icon {
  /* Adjust size and layout as needed */
  width: 24px;
  height: auto;
  margin-bottom: 30px;
}
